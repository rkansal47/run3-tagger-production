...
for point in mpoints:
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.6.5/BulkGraviton_hh_GF_HH_part3/%s_MX%s_MH%s_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz' % (model,point[0], point[1])),
            ...
            PythiaParameters = cms.PSet(
                ...
                processParameters = cms.vstring('25:onMode = off',
                                                '25:oneChannel = 1 1.00000 100 21 21',
