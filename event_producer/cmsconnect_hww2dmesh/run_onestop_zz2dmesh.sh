...
cp -f GeneratorInterface/LHEInterface/data/run_generic_tarball_cvmfs_JHUVariableZMass2DMesh.sh GeneratorInterface/LHEInterface/data/run_generic_tarball_cvmfs_JHUVariableZMass.sh
