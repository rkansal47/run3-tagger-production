...
for mh, wh, htmin in mpoints:
    # print('PairVectorLQ_LQToBTau_MLQ%.0f_WLQ%.2f_HTmin%.0f' % (mh, wh, htmin))
    generator.RandomizedParameters.append(
        cms.PSet(
            ConfigWeight = cms.double(1),
            GridpackPath =  cms.string('instMG://PairVectorLQ_LQToBTau/MG5_aMC_v2.6.5/%.0f:%.2f:%.0f' % (mh, wh, htmin)),
            ConfigDescription = cms.string('PairVectorLQ_LQToBTau_MLQ%.0f_WLQ%.2f_HTmin%.0f' % (mh, wh, htmin)),
